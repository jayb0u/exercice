...
public class CharacterRotation : MonoBehaviour
{
    ...
    void ReplaceCamera()
    {
        mainCamTransform.position = Vector3.Lerp(mainCamTransform.position, camPositioner.position, elapsticity);
        mainCamTransform.rotation = Quaternion.Lerp(mainCamTransform.rotation, camPositioner.rotation, elapsticity);
    }
